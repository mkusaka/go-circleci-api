...
// InlineResponse2006MetricsDurationMetrics Metrics relating to the duration of runs for a workflow.
type InlineResponse2006MetricsDurationMetrics struct {
...
func NewInlineResponse2006MetricsDurationMetrics(min int64, mean int64, median int64, p95 int64, max int64, standardDeviation float32) *InlineResponse2006MetricsDurationMetrics {
	this := InlineResponse2006MetricsDurationMetrics{}
	this.Min = min
	this.Mean = mean
	this.Median = median
	this.P95 = p95
...
func (o InlineResponse2006MetricsDurationMetrics) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse2006MetricsDurationMetrics struct {
	value *InlineResponse2006MetricsDurationMetrics
	isSet bool
}

func (v NullableInlineResponse2006MetricsDurationMetrics) Get() *InlineResponse2006MetricsDurationMetrics {
	return v.value
}

func (v *NullableInlineResponse2006MetricsDurationMetrics) Set(val *InlineResponse2006MetricsDurationMetrics) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse2006MetricsDurationMetrics) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse2006MetricsDurationMetrics) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse2006MetricsDurationMetrics(val *InlineResponse2006MetricsDurationMetrics) *NullableInlineResponse2006MetricsDurationMetrics {
	return &NullableInlineResponse2006MetricsDurationMetrics{value: val, isSet: true}
}

func (v NullableInlineResponse2006MetricsDurationMetrics) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse2006MetricsDurationMetrics) UnmarshalJSON(src []byte) error {
	v.isSet = true
