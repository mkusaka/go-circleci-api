...
// GetSetupConfig returns the SetupConfig field value if set, zero value otherwise.
func (o *PipelineConfig) GetSetupConfig() string {
	if o == nil || o.SetupConfig == nil {
		var ret string
		return ret
	}
...
// GetSetupConfigOk returns a tuple with the SetupConfig field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PipelineConfig) GetSetupConfigOk() (*string, bool) {
	if o == nil || o.SetupConfig == nil {
		return nil, false
	}
	return o.SetupConfig, true
}
...
// SetSetupConfig gets a reference to the given string and assigns it to the SetupConfig field.
func (o *PipelineConfig) SetSetupConfig(v string) {
	o.SetupConfig = &v
}

// GetCompiledSetupConfig returns the CompiledSetupConfig field value if set, zero value otherwise.
func (o *PipelineConfig) GetCompiledSetupConfig() string {
	if o == nil || o.CompiledSetupConfig == nil {
		var ret string
		return ret
	}
	return *o.CompiledSetupConfig
}

// GetCompiledSetupConfigOk returns a tuple with the CompiledSetupConfig field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PipelineConfig) GetCompiledSetupConfigOk() (*string, bool) {
	if o == nil || o.CompiledSetupConfig == nil {
		return nil, false
	}
	return o.CompiledSetupConfig, true
}
...
// SetCompiledSetupConfig gets a reference to the given string and assigns it to the CompiledSetupConfig field.
func (o *PipelineConfig) SetCompiledSetupConfig(v string) {
	o.CompiledSetupConfig = &v
}
...
func (o PipelineConfig) MarshalJSON() ([]byte, error) {
	...
	if o.SetupConfig != nil {
		toSerialize["setup-config"] = o.SetupConfig
	}
	if o.CompiledSetupConfig != nil {
		toSerialize["compiled-setup-config"] = o.CompiledSetupConfig
	}
