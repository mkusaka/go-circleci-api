...
func (r ApiCreateEnvVarRequest) EnvironmentVariablePair1(environmentVariablePair1 EnvironmentVariablePair1) ApiCreateEnvVarRequest {
	r.environmentVariablePair1 = &environmentVariablePair1
	return r
}

func (r ApiCreateEnvVarRequest) Execute() (*EnvironmentVariablePair1, *http.Response, error) {
...
func (a *ProjectApiService) CreateEnvVarExecute(r ApiCreateEnvVarRequest) (*EnvironmentVariablePair1, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *EnvironmentVariablePair1
	)
	...
	// body params
	localVarPostBody = r.environmentVariablePair1
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["api_key_header"]; ok {
...
func (r ApiGetEnvVarRequest) Execute() (*EnvironmentVariablePair1, *http.Response, error) {
...
// Execute executes the request
//  @return EnvironmentVariablePair1
func (a *ProjectApiService) GetEnvVarExecute(r ApiGetEnvVarRequest) (*EnvironmentVariablePair1, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
